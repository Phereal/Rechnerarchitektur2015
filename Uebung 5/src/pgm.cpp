...
void write_pgm(string filename, int width, int height, const pgm_image &image, int color_depth) {
...
void read_pgm(string filename, int &width, int &height, int &depth, pgm_image &image) {
